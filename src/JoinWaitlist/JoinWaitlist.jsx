...
function JoinWaitlist() {
  ...
  useEffect(() => {
    if (component === "login")
      setDisplayComp(<ContactForm setComponent={setComponent} />);
    else if (component === "success")
      setDisplayComp(<SignUpSuccess setComponent={setComponent} />);
    else if (component === "fail")
      setDisplayComp(<SignUpFail setComponent={setComponent} />);
  }, [component]);
    ...
    <div className="joinWaitlist__container">
      ...
      <div className="joinWaitlist__footer">
        ...
        >
          <svg
            class="insta-logo"
            fill={`${windowWidth > 1100 ? "white" : "black"}`}
        ...
        <a href="https://twitter.com/sayfinvest" target="_blank">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
            viewBox="0 0 24 24"
            fill={`${windowWidth > 1100 ? "white" : "#1DA1F2"}`}
          >
